...
import com.blog.blogservice.dto.response.*;
import com.blog.blogservice.entity.*;
import com.blog.blogservice.repository.*;
import com.blog.blogservice.service.*;
import com.blog.blogservice.util.SlugUtil;
...
//	AuthClient authClient;
	...
	public Page<PostSummaryResponse> getAllPostSummary(int page, int size, String search, List<Long> categoryIds) {
		...
		List<SimpInfoUserResponse> users = authService.getUserByIds(new ArrayList<>(uids));
